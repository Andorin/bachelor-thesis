...
\end{itemize}
We started by trying some leftovers from recent researches. \textbf{TODO: Find names of the fabrics and materials} We placed the materials between the pinstripe fabric without fixation to examine 
