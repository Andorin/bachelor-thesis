...
Then we place the materials between the pinstripe fabric to examine different behaviors. We glued the both layers of the pinstripe fabric to sheets of paper to eliminate the stretching and curling of the fabric. Some of the the materials are cut with a laser-cutter. We cut equidistant circular holes to provide space for the pinstripe layers to connect.  Therefore we  create a program, using Processing, that displays where a touch is present. We attached 4 by 4 pinstripes to the MSP430 micro-controller. 
